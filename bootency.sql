/*
 ...
 Source Schema         : bootency

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 13/07/2020 17:44:05
*/
...
-- ----------------------------
INSERT INTO `admin_roles` VALUES (1, 'Administrator', 'administrator', '2020-07-13 03:35:43', '2020-07-13 03:35:43');
...
-- ----------------------------
INSERT INTO `admin_users` VALUES (1, 'admin', '$2y$10$zMn0Hyh0pmb08PTm4yfe0ehVg8n..ZOqUWHEPbaBvWtj0uyKqu.3m', 'Administrator', NULL, NULL, '2020-07-13 03:35:43', '2020-07-13 03:35:43');
...
CREATE TABLE `by_order`  (
  ...
  `transaction_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '交易编号',
  ...
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '订单状态0代支付1用户取消',
  `pay_status` tinyint(1) NULL DEFAULT NULL COMMENT '支付状态0待支付1支付成功2支付失败',
  `shipping_status` tinyint(1) NULL DEFAULT NULL COMMENT '物流状态0待配送1已发货2已签收',
...
-- ----------------------------
-- Table structure for by_shipping_address
-- ----------------------------
DROP TABLE IF EXISTS `by_shipping_address`;
CREATE TABLE `by_shipping_address`  (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL DEFAULT 0,
  `country` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '国家',
  ...
  `zip_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '邮编',
  `receive_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1默认收获0普通',
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for by_social_account
-- ----------------------------
DROP TABLE IF EXISTS `by_social_account`;
CREATE TABLE `by_social_account`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NULL DEFAULT NULL,
  `source` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '第三方平台标识',
  `openid` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '第三方用户唯一标识',
  `access_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '第三方access_token,校验使用',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `by_user`  (
  ...
  `expire_in` int(11) NOT NULL DEFAULT 0 COMMENT '过期时间',
